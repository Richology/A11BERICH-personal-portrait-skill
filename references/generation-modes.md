...
User instructions override every default below. All modes retain the identity profile and select a crop appropriate to the intended channel.
...
| 休闲运动 | Walking, stretching, light training, or natural active stance | Fitted technical casualwear or sportswear | Pink/rose lenses by default | Daylight or clean gym/outdoor light; preserve lean-muscular proportions |
| 潮酷 | Confident editorial stance, movement, or asymmetric composition | Trend-forward layers and strong silhouette | Pink/rose lenses by default | Graphic/editorial light; avoid costume-like exaggeration and unrequested logos |
| 伦勃朗光肖像 | Calm direct gaze, three-quarter stance, or restrained confident smile | Black or white minimal top unless requested otherwise | Pink/rose lenses by default, matching approved V5/V6 style | Warm Rembrandt triangle, dark seamless background, realistic skin and cloth texture |
